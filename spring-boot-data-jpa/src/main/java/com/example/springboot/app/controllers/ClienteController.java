...
public class ClienteController {
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model, SessionStatus status) { //@Valid habilita la validacion en el objeto mapeado al Form
